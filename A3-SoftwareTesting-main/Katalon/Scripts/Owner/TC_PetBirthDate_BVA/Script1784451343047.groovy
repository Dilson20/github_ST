...
// Compute the pet's birth date from the data-driven offset, fresh, inline
def cal = Calendar.getInstance()
cal.add(Calendar.DATE, Integer.parseInt(dateOffset))
def birthDate = cal.getTime().format('MM/dd/yyyy')
...
WebUI.setText(findTestObject('Page_Testing-Site  a Spring Framework demonstration/input_Birth Date'), birthDate)
