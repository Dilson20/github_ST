...
public class PetStepDefinitions {
    ...
    public void i_edit_the_pet_named_and_change_the_name_to_and_type_to(String oldName, String newName, String newType) {
        if (!ownerDetailsPage.hasPetNamed(oldName) && ownerDetailsPage.hasPetNamed(newName)) {
            petFormPage = ownerDetailsPage.clickEditPet(newName);
            petFormPage.enterName(oldName)
                       .selectType("cat")
                       .clickSubmitExpectingSuccess();
        }
